...
class FetchNewsByKategori extends StatefulWidget {
  final int idBerita;
  ...
  @override
  _FetchNewsByKategoriState createState() => _FetchNewsByKategoriState();
}

class _FetchNewsByKategoriState extends State<FetchNewsByKategori> {
