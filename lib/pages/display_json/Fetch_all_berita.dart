...
class FetchAllBerita extends StatefulWidget {
  final int idBerita;
  ...
  @override
  _FetchAllBeritaState createState() => _FetchAllBeritaState();
}

class _FetchAllBeritaState extends State<FetchAllBerita> {
